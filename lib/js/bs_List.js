  ...
  while(true) {
    ...
    if (l1) {
      if (l2) {
        ...
        throw new Error("List.fold_left2");
      }
    } else if (l2) {
      throw new Error("List.fold_left2");
    } else {
...
function fold_right2(f, l1, l2, accu) {
  if (l1) {
    if (l2) {
      ...
      throw new Error("List.fold_right2");
    }
  } else if (l2) {
    throw new Error("List.fold_right2");
  } else {
